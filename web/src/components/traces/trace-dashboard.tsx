...
const copy = {
  en: {
    ...
    started: "Started", ended: "Ended", lastObserved: "Last observed", attempts: "Attempts", summary: "Trace summary", runChat: "Run / Chat", agentModel: "Agent / Model", latency: "Latency", tokens: "Tokens", cost: "Cost", open: "Open Trace", lagged: "Projection lagged", incomplete: "Incomplete", next: "Next page", previous: "Previous page",
  ...
  zh: {
    ...
    started: "开始时间", ended: "结束时间", lastObserved: "最近观测", attempts: "尝试次数", summary: "Trace 摘要", runChat: "Run / Chat", agentModel: "Agent / 模型", latency: "耗时", tokens: "Token", cost: "成本", open: "打开 Trace", lagged: "投影滞后", incomplete: "未完成", next: "下一页", previous: "上一页",
...
function TraceDetailView(props: TraceDashboardProps & { traceID: string }) {
  ...
  return (
    <main className="trace-shell trace-detail">
      <TraceTopbar title={summary.run_id} onBack={() => props.onNavigate("/admin/traces")} backLabel={t.explorer} />
