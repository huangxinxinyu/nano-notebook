...
func completeSuite() rageval.Suite {
	...
	return rageval.Suite{SchemaVersion: 1, ID: "sprint6-v1", Cases: cases, Thresholds: rageval.Thresholds{
		MinRecall: 1, MinMRR: .9, MinSourceReferencePrecision: 1,
...
func pinnedConfig() rageval.PinnedConfig {
	return rageval.PinnedConfig{
		...
		ComposerModel: "composer-v1", PromptVersion: "prompt-v1", AgentConfigID: "agent-v1",
	}
}
...
func passingObservation(evalCase rageval.Case) rageval.Observation {
	...
	return rageval.Observation{CaseID: evalCase.ID, FixtureSHA256: fixtures, CoveragePassed: true, RetrievedEvidenceIDs: retrieved, CitationSourceIDs: sources, RequiredFactsFound: append([]string(nil), evalCase.RequiredFacts...), LatencyMilliseconds: 100, EstimatedCostUSD: .01}
}
