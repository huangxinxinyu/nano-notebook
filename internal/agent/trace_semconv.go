...
const (
	...
	TraceSpanClaimSupport   = "nano.claim_support"
)
...
const (
	...
	TraceKeyVerifierPromptVersion     = "nano.rag.verifier.prompt_version"
	TraceKeyVerifierClaimCount        = "nano.rag.verifier.claim_count"
	TraceKeyVerifierEvidenceCount     = "nano.rag.verifier.evidence_count"
	TraceKeyVerifierSupportedCount    = "nano.rag.verifier.supported_count"
	TraceKeyVerifierUnsupportedCount  = "nano.rag.verifier.unsupported_count"
